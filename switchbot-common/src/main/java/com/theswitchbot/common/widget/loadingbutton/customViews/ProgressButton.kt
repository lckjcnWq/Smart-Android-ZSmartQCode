...
import com.theswitchbot.common.widget.loadingbutton.animatedDrawables.CircularProgressAnimatedDrawable
import com.theswitchbot.common.widget.loadingbutton.animatedDrawables.CircularRevealAnimatedDrawable
import com.theswitchbot.common.widget.loadingbutton.animatedDrawables.ProgressType
import com.theswitchbot.common.widget.loadingbutton.presentation.State
import com.theswitchbot.common.widget.loadingbutton.updateHeight
import com.theswitchbot.common.widget.loadingbutton.updateWidth
import com.theswitchbot.common.widget.loadingbutton.utils.addLifecycleObserver
import com.theswitchbot.common.widget.loadingbutton.utils.parseGradientDrawable
...
internal fun ProgressButton.config(tArray: TypedArray) {
    initialCorner = tArray.getDimension(R.styleable.CircularProgressButton_initialCornerAngle, dp(getContext(),10).toFloat())
    finalCorner = tArray.getDimension(R.styleable.CircularProgressButton_finalCornerAngle, dp(getContext(),50).toFloat())
...
internal fun cornerAnimator(drawable: Drawable, initial: Float, final: Float) =
    when (drawable) {
        is GradientDrawable -> ObjectAnimator.ofFloat(drawable as GradientDrawable, "cornerRadius", initial, final)
