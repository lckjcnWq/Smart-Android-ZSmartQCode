...
import com.theswitchbot.common.widget.loadingbutton.disposeAnimator
import com.theswitchbot.common.widget.loadingbutton.presentation.ProgressButtonPresenter
...
open class CircularProgressButton : AppCompatButton, ProgressButton {
    ...
    private val initialWidth: Int by lazy { width }
    ...
    override fun saveInitialState() {
        initialState = InitialState(initialWidth, text, compoundDrawables)
    }

    fun setInitState(){
        presenter.initButtonView()
        invalidate()
    }
