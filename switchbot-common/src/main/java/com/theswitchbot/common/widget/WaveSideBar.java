...
public class WaveSideBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mTextSize = context.getResources().getDimensionPixelSize(R.dimen.dp_10);
        mHintTextSize = context.getResources().getDimensionPixelSize(R.dimen.dp_32);
        ...
        if (attrs != null) {
            ...
            mTextColor = a.getColor(R.styleable.waveSideBar_wsTextColor, mTextColor);
