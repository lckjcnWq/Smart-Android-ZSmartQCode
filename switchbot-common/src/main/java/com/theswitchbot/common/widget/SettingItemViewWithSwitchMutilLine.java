 ...
 */
public class SettingItemViewWithSwitchMutilLine extends RelativeLayout {
    Context mContext;
    ...
    public SettingItemViewWithSwitchMutilLine(Context context) {
        super(context);
        mContext = context;
    }

    public SettingItemViewWithSwitchMutilLine(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init(attrs, 0);
    }

    public SettingItemViewWithSwitchMutilLine(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        View.inflate(getContext(), R.layout.view_title_right_text_and_arrow_mutil_line, this);
