package com.theswitchbot.common.widget.wheelpicker;
...
import com.theswitchbot.common.widget.wheelpicker.IDebug;
...
public class WheelPicker extends View implements IDebug, IWheelPicker, Runnable {
    ...
    public WheelPicker(Context context, AttributeSet attrs) {
        ...
        mItemAlign = a.getInt(R.styleable.WheelPicker_wheel_item_align_wo, ALIGN_CENTER);
        fontPath = a.getString(R.styleable.WheelPicker_wheel_font_path);
        a.recycle();

        // 可见数据项改变后更新与之相关的0_5参数
