package com.theswitchbot.common.widget.step;
...
public class StepsView extends LinearLayout implements StepsViewIndicator.OnDrawListener {
    ...
    public StepsView(Context context, AttributeSet attrs,
        ...
        int defaltMagin = widthPixels / 20;
        int defaltRadiu = widthPixels / 25;
        Log.i("view width", widthPixels + ":" + defaltMagin + ":" + defaltRadiu);
        TypedArray arr = context.obtainStyledAttributes(attrs, R.styleable.StepsView);
        ...
        int barColor = arr.getColor(R.styleable.StepsView_viewBarColor, Color.GRAY);
        int progressColor = arr.getColor(R.styleable.StepsView_stepsViewProgressColor, ContextCompat.getColor(context, R.color.orange));
        ...
        float progressMargin = arr.getFloat(R.styleable.StepsView_progressMargin, defaltMagin);
        float circleRadius = arr.getFloat(R.styleable.StepsView_stepCircleRadius, defaltRadiu);
    ...
    public void drawView() {
        ...
        Log.d("duebug", "mCompletedPosition:" + +mCompletedPosition + ";mTotalSteps:" + mTotalSteps);
